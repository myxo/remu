...
pub const CREATE_ACTIVE_EVENT_TABLE: &str = "CREATE TABLE IF NOT EXISTS active_event(
...
pub const CREATE_REP_EVENT_TABLE: &str = "CREATE TABLE IF NOT EXISTS scheduled_event(
        id                  INTEGER PRIMARY KEY AUTOINCREMENT,
        uid                 INTEGER NOT NULL,
        event_text          TEXT NOT NULL,
        event_time          INTEGER,
...
pub const GET_ALL_USER_CHAT_ID: &str = "SELECT chat_id FROM user";
...
pub const DELETE_FROM_ACTIVE_EVENT_BY_ID: &str = "DELETE FROM active_event WHERE id = ?1;";
